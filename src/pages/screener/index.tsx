        ...
        >
          <thead>
            <tr>
              ...
              <th style={{ width: 140, padding: '12px 6px' }}>交易所</th>
              <th style={{ width: 240, padding: '12px 6px' }}>上市日期</th>
              ...
              <tr key={row.symbol}>
                {/* <td style={{ textAlign: 'center', width: 120 }}>
                  <Checkbox
                    ...
                    color={selected.includes(row.symbol) ? 'primary' : undefined}
                    onChange={(event) => {
                      setSelected((ids) =>
                        event.target.checked
                          ? ids.concat(row.symbol)
                          : ids.filter((itemId) => itemId !== row.symbol),
                      );
                    }}
                ...
                <td>
                  <Typography level="body-xs">{row.exchange}</Typography>
                </td>
                <td>
